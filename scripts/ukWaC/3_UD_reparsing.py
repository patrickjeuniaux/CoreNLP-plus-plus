...
3_UD_reparsing.py
-----------------
Parse the refurbished corpora (BNC, ukWac, Wiki 2013)
...
java -cp "$CORENLP" -mx8g edu.stanford.nlp.pipeline.StanfordCoreNLPServer -port 9000 -timeout 2400000
...
export SRC="/home/$USER/Documents/dashboard/projects/CoreNLP/datasets/ukWaC"


$PYTHON $SRC/3_UD_reparsing.py
...
#CONFIG_PATH = "/home/patrick/Documents/dashboard/projects/Wiki2018/ukWaC_config.cnf"
CONFIG_PATH = "ukWaC_config.cnf"
